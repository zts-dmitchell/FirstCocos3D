...
1. Once this template project opens, select your `FirstCocos3D` project in the 
   Xcode *Project Navigator* panel.

2. Select the `FirstCocos3D` target.

3. Select the *Build Phases* tab of the `FirstCocos3D` target.
...
`FirstCocos3DScene.m` file. To add your own 3D content, edit that method.

The `FirstCocos3DScene.m` file is also where you add interactive behaviour,
