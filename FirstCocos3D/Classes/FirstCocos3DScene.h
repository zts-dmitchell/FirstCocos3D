...
@property(assign, nonatomic) CC3Vector droppedSpindlesLocation;
...
@property(assign, nonatomic) CC3Vector taillightsPos;
...
@property(strong, nonatomic) CC3Node* headersNode;
